...
int main(void) {
    ...
    printf(
        "      msg1 -->>        stuno     stuname       msg2 -->>         "
        "stuno     stuname  nationaluty\n");
    printf(
        "===================  =========  ========  ===================  "
        "=========  ========  ============\n");
...
void print_msg1(void) {
    ...
    struct msg_struct1 *ptr =
        (struct msg_struct1 *)pthread_getspecific(tls_key);
...
static void *thread_func2(void *args) {
    ...
    ptr = (struct msg_struct2 *)malloc(
        5 * sizeof(struct msg_struct2)); /* storage in process heap */
...
void print_msg2(void) {
    int randomcount;
    struct msg_struct2 *ptr =
        (struct msg_struct2 *)pthread_getspecific(tls_key);
